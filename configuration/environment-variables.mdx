...
| Value  | Notes                                                            |
| ------ | ---------------------------------------------------------------- |
| `svg`  | Vector — scales perfectly at any size, no image extension needed |
| `png`  | Raster — requires GD or Imagick                                  |
| `webp` | Modern raster — requires GD or Imagick                           |
| `eps`  | Vector for print; image merging is not supported in this format  |
...
```ini
# Transparent background (PNG/WebP only; alpha 0 = fully transparent)

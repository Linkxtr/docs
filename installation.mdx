...
description: "Add the linkxtr/laravel-qrcode package to your Laravel 11+ project with Composer, then optionally publish the config to set app-wide defaults."
---

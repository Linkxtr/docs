...
| ------------------ | ---- | ------- | ------------------ |
| **v3.x** (current) | 8.2+ | 11+     | Active development |
| v2.x               | 8.2+ | 11+     | Maintenance only   |
| v1.x               | 8.1+ | 10      | Maintenance only   |

Always install `linkxtr/laravel-qrcode` without a version constraint to get the latest v3.x release. If your project runs Laravel 10, pin to `^1.0` instead.

<Tip>
  Upgrading from v2.x? Read the [Upgrade
  Guide](https://github.com/Linkxtr/laravel-qrcode/blob/main/docs/UPGRADE-3.0.md)
  before updating — the v3 API is a breaking change from the v2 interface.
</Tip>

...
<Tip>
  Macros are ideal for standardizing QR generation patterns across your application. Define one macro per business concept — `AssetTag`, `ProductLabel`, `EventTicket` — and every developer on your team gets a consistent, documented interface without having to know the payload format.
</Tip>

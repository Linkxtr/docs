...
<ParamField body="c1" type="int" required>
  **RGB mode:** Red channel, 0–255.  
  **CMYK mode:** Cyan channel, 0–100.
</ParamField>

<ParamField body="c2" type="int" required>
  **RGB mode:** Green channel, 0–255.  
  **CMYK mode:** Magenta channel, 0–100.
</ParamField>

<ParamField body="c3" type="int" required>
  **RGB mode:** Blue channel, 0–255.  
  **CMYK mode:** Yellow channel, 0–100.
</ParamField>

<ParamField body="c4" type="int | null">
  **RGB mode:** Alpha channel, 0–100 (0 = fully opaque).  
  **CMYK mode:** Black (Key) channel, 0–100.  
  Omit for a fully opaque foreground.
</ParamField>
